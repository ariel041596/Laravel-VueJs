              ...
              >
                ...
                <tbody>
                  <template v-if="assets.data<=0">
                    <tr>
                      <td colspan="15" class="text-center">No Request For Return Available</td>
                    </tr>
                  </template>
                  <template v-else>
                    <tr v-for="asset in assets.data" :key="asset.id">
                      ...
                      <td>
                        ...
                        <a
                          ...
                          title="For Disposal"
                        >
                          <i class="material-icons fas fa-trash-restore-alt red"></i>
                          <!-- <i class="material-icons">add</i> -->
                        </a>
                        <a
                          v-if="$gate.isAdminOrUserOrAuthor()"
          ...
          <form @submit.prevent="editmode ? updateAsset3() : createAsset()">
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                class="update-create mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect"
              >
                <i class="fas fa-thumbs-up">&nbsp;</i>For Disposal
              </button>
              <!-- <button
                :disabled="noremarks"
                v-show="editmode"
...
export default {
  ...
  methods: {
    ...
    updateAsset2() {
      ...
      this.form
        .put("api/return-request/" + this.form.id)
